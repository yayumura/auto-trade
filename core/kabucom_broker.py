    ...
    def cancel_order(self, order_id: str) -> CancelResult:
        ...
        if submission.status == SubmissionStatus.ACCEPTED:
            ...
            append_order_journal({
                ...
                "http_status": submission.http_status,
                "result": submission.result_code,
                "execution_ids": tuple(parsed.execution_ids) if parsed_order is not None else (),
                "execution_id": parsed.execution_ids[0] if parsed_order is not None and parsed.execution_ids else None,
