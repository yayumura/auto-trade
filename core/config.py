...
ATR_STOP_LOSS         = 1.5    # [V19.0] Tight Stop for High Turnover
TARGET_PROFIT_MULT    = 2.0    # [V19.0] Short Swing Profit Target
...
SMA20_EXIT_BUFFER     = 0.995  # [V19.0] 0.5% Buffer (Tighter for Short Swing)
SMA_SHORT_PERIOD      = 5
